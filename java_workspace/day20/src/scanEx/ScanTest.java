...
public class ScanTest {
	...
	public static void main(String[] args) {
		//D:\GB_0900_05_BSM(다른 폴더나 파일 넣지말아주세요)\java_language\java_resource\data.txt
		String path = "D:\\GB_0900_05_BSM(다른 폴더나 파일 넣지말아주세요)\\java_language\\java_resource\\data.txt";
					  //디렉터리 : 드라이브 + 폴더 + 파일
